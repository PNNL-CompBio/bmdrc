...
Available Models: asymptotic regression, exponential, Gompertz, Hill, log-logistic, Michaelis-Mentin, polynomial regression (Quadratic, Cubic, Quartic, etc), power, Weibull
